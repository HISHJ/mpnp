...
/* $(function(){
	$('#modal-1').on('hidden.bs.modal', function (e) {
		$(this).find('#memberAddressForm').reset();
	})
}) */
function dataReset(){
										...
										<li class="adrs">
											...
											<div class="cdt">
												<div class="uiadrset">
													...
													<div id="adrOff">
														<input type="text" id="addr2" name="addAddr2" placeholder="상세주소를 입력하세요."class="adrbox a1" style="width:100%;">
													</div>
												</div>
											</div>
										</li>
				...
				<div class="layers">
					...
					<div class="pbd " id="popupAddressEdit">
						...
						<div class="pct" style="height: 582px;">
							<main class="poptents">
								<form id="updateAddressForm" action="des_modify_process.do">
									<div class="uidelivsets">
										<ul class="list" id="addressul">
											<li class="name">
												<div class="hdt" >배송지 명칭</div>
												<div class="cdt">
													...
													<input type="hidden" id="editDesId" name="editDesId">
														<input type="text" name="editName" id="editName" placeholder="배송지 명칭을 입력해주세요" >
													</div>
												</div>
											</li>
											<li class="user">
												...
												<div class="cdt">
													<div class="input del">
														<input type="text" name="editReceiver" id="editReceiver" placeholder="이름을 입력해주세요.">
													</div>
												</div>
											</li>
											<li class="phone">
												...
												<div class="cdt">
													<div class="input del">
														<input type="text" name="editPhone" id="editPhone"
											...
											<div class="cdt">
												<div class="uiadrset">
													...
													<div id="adrOff">
														<input type="text" id="editAddr2" name="editAddr2" placeholder="상세주소를 입력하세요."class="adrbox a1" style="width:100%;">
													</div>
												</div>
											</div>
											</li>
