...
<script type="text/javascript">
	...
	$(document).ready(
		function() {
			...
			// 배송지 삭제
			$("[name=deleteAddressBtn]").click(
					function() {
						deleteAddress($(this).data('dlvra-no'), $(this)
								.data('gb-nm'), $(this).data('dftyn'));
					});
		});
			...
			<div class="modal__inner">
				...
				<div class="pbd " id="popupAddressEdit">
					<div class="phd">
						<div class="in">
							<h1 class="tit"
								style="font-size: 20rem; font-weight: bold; margin-bottom: 20px;">배송지
								입력</h1>
						</div>
					</div>
					<div class="pct" style="height: 505.6px;">
						<main class="poptents">
							<form id="memberAddressForm">
								<input type="hidden" name="mbrNo" value="1319879"> <input
									type="hidden" name="mbrDlvraNo" value=""> <input
									type="hidden" name="goodsRcvPstCd" value=""> <input
									type="hidden" name="goodsRcvPstEtc" value=""> <input
									type="hidden" name="pblGateEntMtdCd" value=""> <input
									type="hidden" name="pblGatePswd" value=""> <input
									type="hidden" name="dlvrDemand" value=""> <input
									type="hidden" name="dlvrDemandYn" value="N">
								<div class="uidelivsets">
									<ul class="list" id="addressul">
										<li class="name">
											...
											<div class="cdt">
												<div class="input del">
													<!-- <input type="text" name="gbNm" placeholder="배송지 명칭을 입력해주세요"
														title="배송지" value=""> -->
													<input type="text" name="name" placeholder="배송지 명칭을 입력해주세요"
														title="배송지" value="">
												</div>
											</div>
										</li>
										<li class="user">
											...
											<div class="cdt">
												<div class="input del">
													<!-- <input type="text" name="adrsNm" placeholder="이름을 입력해주세요."
														title="받는 사람" value=""> -->
											...
											<div class="cdt">
												<div class="input del">
													<!-- <input type="text" name="mobile"
														placeholder="-없이 번호만 입력해주세요" title="휴대폰번호" value=""> -->
											...
											<div class="cdt">
												<div class="uiadrset">
													<div class="adrbox a1" id="adrOff">
														...
														<a href="javascript:;" class="btAdr" data-content=""
															data-url="">주소검색</a>
													</div>
													...
													<div class="adrbox a2" data-selected="false"
														style="display: none;">
														<input type="hidden" name="roadAddr" value=""> <input
															type="hidden" name="prclAddr" value=""> <input
															type="hidden" name="postNoNew" value=""> <input
															type="hidden" name="prclDtlAddr" value=""> <span
															class="input"><input type="text"
															name="roadDtlAddr" placeholder="상세주소를 입력하세요." value=""></span>
													</div>
												</div>
											</div>
										</li>
											...
											<div class="cdt">
												<div class="uiadrreq">
													<div class="pwf" id="aftDeliReq" style="display: none;">
														<em class="t" id="goodsRcvPst"> </em> <em class="p"
															id="pblGateEntMtd">&nbsp; <if test="false"> </if>
														</em>
														<div class="txt" id="dlvrDemand"></div>
														<div class="btt">
															<a href="#" onclick="memberAddress.dlvrDemandPop();"
																class="btn sm btMod" data-content="layerAlert"
																data-url="">변경</a>
														</div>
													</div>
													<div class="pss" id="insertDeliReq">
														<a href="#" onclick="memberAddress.dlvrDemandPop();"
															class="btn btPdPl" data-content="layerAlert" data-url="">상품
															수령 장소를 선택해주세요</a>
													</div>
												</div>
												<div class="saves">
													<div class="pp">
														<label class="checkbox"><input type="checkbox"
															name="dftYn" value="N"><span class="txt"><em
																class="tt">기본 배송지로 등록</em></span></label>
													</div>
												</div>
											</div>
										</li>
							...
							<div class="btnList bot">
								<label class="modal__close2" for="modal-1"
									style="cursor: pointer;">취소</label>
								<button type="button" id="addBtn" name="addAddressBtn" onclick="insertAddress();"
									class="btn lg a disabled save" data-content=""
									data-url="insertAddress();"
					...
					<div class="hdt">
						...
						<nav class="tmenu">
							<ul class="list">
								...
								<li id="liTag_10" class=""><a href="/shop/home/" class="bt">스토어</a></li>
								<!-- APET-1250 210728 kjh02  -->
								<li id="liTag_00" class="active"><a
									href="/mypage/indexMyPage/" class="bt">MY</a></li>
							</ul>
						</nav>
					</div>
					<div class="cdt">
				...
				<div class="contents" id="contents" style="min-height: 714px;">
					...
					<div class="pc-tit">
						...
						<label class="btn prooptions add_ship" for="modal-1" href="#"
							style="color: var(- -colors-main03)">배송지 추가</label>
					</div>
									...
									<nav class="uidropmu dmenu ${des.destinationId } ">
										...
										<ul class="menu">
											...
											<li><button type="button" class="bt"
													name="deleteAddressBtn" data-dlvra-no="234869"
													data-gb-nm="집" data-dftyn="Y" data-content=""
													data-url="/mypage/service/deleteAddress">삭제</button></li>
										</ul>
			...
			<div class="modal__inner">
				...
				<div class="layers">
					...
					<div class="pbd " id="popupAddressEdit">
						<div class="phd">
							<div class="in">
								<h1 class="tit" style="font-size: 20rem; font-weight: bold;">배송지
									변경</h1>
							</div>
						</div>
						<div class="pct" style="height: 582px;">
							<main class="poptents">
								<form id="updateAddressForm">
									<input type="hidden" name="mbrNo" value="1319879"> <input
										type="hidden" name="mbrDlvraNo" value="234869"> <input
										type="hidden" name="goodsRcvPstCd" value="10"> <input
										type="hidden" name="goodsRcvPstEtc" value=""> <input
										type="hidden" name="pblGateEntMtdCd" value="30"> <input
										type="hidden" name="pblGatePswd" value=""> <input
										type="hidden" name="dlvrDemand" value="집 문앞에 놓아주세요"> <input
										type="hidden" name="dlvrDemandYn" value="Y">
									<div class="uidelivsets">
										<ul class="list" id="addressul">
											<li class="name">
												<div class="hdt">배송지 명칭</div>
												<div class="cdt">
													<div class="input del">
														<input type="text" name="gbNm"
															placeholder="배송지 명칭을 입력해주세요" title="배송지" value="집">
													</div>
												</div>
											</li>
											<li class="user">
											...
											<li class="phone">
												...
												<div class="cdt">
													<div class="input del">
														<input type="text" name="mobile"
															placeholder="-없이 번호만 입력해주세요" title="휴대폰번호"
															value="01012345678">
													</div>
													<span id="mobileValidate" style="color: red; display: none">휴대폰번호를
														정확히 입력해주세요.</span>
											...
											<li class="adrs">
												...
												<div class="cdt">
													<div class="uiadrset">
														...
														<div class="adrbox a1" data-selected="false">
															<div class="adr on" id="adrOn">경기도 성남시 분당구 판교공원로4길
																27(판교동)</div>
															<a href="javascript:;" class="btAdr" data-content=""
																data-url="">주소검색</a>
														</div>
														<div class="adrbox a2" data-selected="false">
															<input type="hidden" name="roadAddr"
																value="경기도 성남시 분당구 판교공원로4길 27(판교동)"> <input
																type="hidden" name="prclAddr"
																value="경기도 성남시 분당구 판교동 553 분당판교청소년수련관, 판교도서관"> <input
																type="hidden" name="postNoNew" value="13477"> <input
																type="hidden" name="prclDtlAddr" value="아파트"> <span
																class="input"><input type="text"
																name="roadDtlAddr" placeholder="상세주소를 입력하세요."
																value="아파트"></span>
														</div>
													</div>
												</div>
											...
											<li class="dreq" data-selected="false">
												...
												<div class="saves">
													<div class="pp">
														<label class="checkbox"><input type="checkbox"
															name="dftYn" value="Y" checked=""><span
						...
						<div class="btnList bot">
							...
							<button type="button" id="addBtn" onclick="updateAddress();"
								class="btn lg a">저장</button>
						</div>
						</main>
					</div>
				</div>
