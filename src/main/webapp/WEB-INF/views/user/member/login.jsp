...
<link rel="stylesheet" href="http://localhost/mfnf/3rdDesign/css/login.css">
            ...
            <div class="poptents">
              ...
              <div class="member-input">
                <ul class="list">
                  <li>
                    <div class="input">
                      <input type="text" class="ipt" name="loginId" id="login_login_id" placeholder="아이디" autocomplete="new-password" maxlength="40" autofocus>
                    </div>
                  </li>
                  <li>
                    <div class="input">
                      <input type="password" class="ipt" name="pswd" id="login_password" placeholder="비밀번호" autocomplete="new-password" maxlength="15">
                    </div>
