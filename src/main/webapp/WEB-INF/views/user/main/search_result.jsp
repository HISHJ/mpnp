...
<div class="block-wrap">
	<div class="search_left">
		...
		<a class="gd-link" href="prddetail.do?productid=${result.productid}" data-dispcornno="" data-disptype="commonSearchHist" data-idx="0" data-content="GS251062051" data-url="/goods/indexGoodsDetail?goodsId=GS251062051">
			 <div class="gd-thumb">
				<img class="thumb-img" src="http://localhost/mpnp/upload/product/${result.thimg}?type=f&amp;w=178&amp;h=178&amp;quality=90&amp;align=4" alt="${result.productname}" onerror="http://localhost/mpnp/upload/product/${result.thimg}">
				<div class="gd-flag">
					</div>
